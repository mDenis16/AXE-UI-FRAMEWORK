...
ImColor ( 255, 255, 255, 25 ) );
		...
		if ( this->children.size ( ) >= 2 ) {
				renderer->AddBezierCurve ( ImVec2(this->maxs.x, this->mins.y), calculate_center( this->children.at ( 1 )->mins, this->children.at ( 1 )->maxs), ui::calculate_center ( this->children.at ( 0 )->mins, this->children.at ( 0 )->maxs ), ImVec2(this->mins.x, this->maxs.y), ImColor ( 255, 255, 255, 125 ), 2.f, 30 );
		}
