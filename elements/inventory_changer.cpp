...
//	auto center_side = new child_window ( "sadds", 100.f, 50.f, ImColor ( 255, 255, 255, 0 ), weapons_panel, float_side::none, 0.f, 0.f );
	...
	void paintkit::generate_image_path() {
		...
		//if (strcmp(weapon_name.c_str(), ("unknown")) && strcmp(weapon_name.c_str(), ("knife")) && strcmp(weapon_name.c_str(), ("gloves"))) //-V526
		//{
		//	if (skin_name.empty() || skin_name == ("default"))
		//		image_path = ("resource/flash/econ/weapons/base_weapons/") + std::string(weapon_name) + (".png");
		//	else
		//		image_path = ("resource/flash/econ/default_generated/") + std::string(weapon_name) + ("_") + std::string(skin_name) + ("_light_large.png");
		//}
		//else {
		//	if (!strcmp(weapon_name.c_str(), ("knife")))
		//		image_path = ("resource/flash/econ/weapons/base_weapons/weapon_knife.png");
		//	else if (!strcmp(weapon_name.c_str(), ("gloves")))
		//		image_path = ("resource/flash/econ/weapons/base_weapons/ct_gloves.png");
		//	else if (!strcmp(weapon_name.c_str(), ("unknown")))
		//		image_path = ("resource/flash/econ/weapons/base_weapons/weapon_snowball.png");
